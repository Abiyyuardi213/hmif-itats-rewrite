<footer class="bg-white text-slate-600 py-20 border-t border-slate-100 text-sm">
    <div class="max-w-[1600px] mx-auto px-6 sm:px-10 lg:px-12">
            ...
            <div class="col-span-1 md:col-span-1">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <div class="flex flex-col">
                        <h3 class="font-extrabold text-slate-900 leading-tight">HMIF ITATS</h3>
                        <span class="text-[10px] text-slate-400 font-bold uppercase tracking-widest">Est. 1991</span>
                    </div>
                </div>
        ...
        <div
            ...
            <p>&copy; 2025 HMIF ITATS. HANDCRAFTED WITH PRIDE.</p>
